# Claude Collaboration Interface — Practical Guide

This file is the **constitution** of the collaboration interface. Claude Code reads it at the start of every conversation. It defines identity, behavior, conventions, workflows, and project structure. Everything here is actionable — not aspirational.
...
### What goes public
- `CLAUDE.md` — This file. The identity and rules are the example.
